            ...
            userTable = filteredStudentsByName.map((item) => {
                ...
                return(
                    <tr key={item.id}>
                        ...
                        <td>{item.semester}</td>
                        <td>{item.year}</td>
                        <td style={item.grade === 'inc' || item.grade === 'INC'? {background_color: 'yellow'} : {color: 'black'}}>{item.grade}</td>
                        <td style={item.re_exam === 'inc' || item.re_exam === 'INC'? {background_color: 'yellow'} : {color: 'black'}}>{item.re_exam}</td>
